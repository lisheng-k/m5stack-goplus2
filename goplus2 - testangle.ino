...
void Servo()
{
  while (num == 1) {
    ...
    goPlus.Servo_write_angle(SERVO_NUM0,  45);
    goPlus.Servo_write_angle(SERVO_NUM1 , 45);
    goPlus.Servo_write_angle(SERVO_NUM2 , 45);
    goPlus.Servo_write_angle(SERVO_NUM3 , 45);
    delay(1000);
        goPlus.Servo_write_angle(SERVO_NUM0,  90);
    goPlus.Servo_write_angle(SERVO_NUM1 , 90);
    goPlus.Servo_write_angle(SERVO_NUM2 , 90);
    goPlus.Servo_write_angle(SERVO_NUM3 , 90);
    delay(1000);
        goPlus.Servo_write_angle(SERVO_NUM0,  135);
    goPlus.Servo_write_angle(SERVO_NUM1 , 135);
    goPlus.Servo_write_angle(SERVO_NUM2 , 135);
    goPlus.Servo_write_angle(SERVO_NUM3 , 135);
    delay(1000);
            goPlus.Servo_write_angle(SERVO_NUM0,  180);
    goPlus.Servo_write_angle(SERVO_NUM1 , 180);
    goPlus.Servo_write_angle(SERVO_NUM2 , 180);
    goPlus.Servo_write_angle(SERVO_NUM3 , 180);
    delay(1000);
